    ...
    <Grid container spacing={0}>
      ...
      <Grid item xs={12} sm={12} md={12} className="mt-20 pl-5">
        <ol className="fancy_list">
          ...
          <li>
            הנני מצהיר/ה בזה, שכל הפרטים שמסרתי ואמסור הקשורים להליך קבלת הדירה
            בדיור הציבורי ולאחר מכן, לרבות לצורך קביעת גובה שכר הדירה ולשימוש
            הנאות בדירה בהתאם לכללי המשרד הם אמת.
          </li>
          <li>
            {" "}
          ...
          <li>
            ...
            להשיג או לבדוק נתונים הקשורים להצהרותיי במסגרת זו במאגרי מידע, לרבות
            במאגרי המידע של : רשות המיסים, מרשם אוכלוסין, ביטוח לאומי, ביקורת
            גבולות, רשות בתי הסוהר, בחקירות או בכל דרך שהיא.{" "}
          </li>
          <li>
            {" "}
