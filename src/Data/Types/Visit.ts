...
import { ITableCodeItem, IVisitContext } from "../Interfaces/Visit";
...
type VisitAction =
  ...
  | { type: "setTableCode"; tableCode: Map<string, ITableCodeItem[]> };
...
type VisitContextType = {
  ...
  setTableCode: (tableCode: Map<string, ITableCodeItem[]>) => void;
};
